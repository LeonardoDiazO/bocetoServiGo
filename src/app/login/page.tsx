...
const ServiGoLogo = () => (
     <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" className="h-24 w-24 mb-4 text-white">
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      if (userEntry && userEntry.password === password) {
        ...
        // Redirection will be handled by context/auth guard hooks
    ...
    <div className="w-full lg:grid lg:min-h-screen lg:grid-cols-2 animate-in fade-in-0 duration-500">
      <div className="relative hidden bg-primary-dark lg:flex flex-col items-center justify-center p-10 text-white">
        ...
        <div className="relative z-20 flex flex-col items-center text-center">
            ...
            <p className="text-xl mt-4 text-white/80">Optimización y Trazabilidad en Campo</p>
        </div>
      </div>
      <div className="flex items-center justify-center min-h-screen py-12 bg-white relative">
        {isLoggingIn && (
        ...
        <div className="mx-auto grid w-[350px] gap-6">
          ...
          <form onSubmit={handleLogin} className="grid gap-4">
            ...
            <Button type="submit" className="w-full btn-gradient text-white font-semibold h-12" disabled={isLoggingIn}>
                Acceder
            </Button>
          </form>
        </div>
